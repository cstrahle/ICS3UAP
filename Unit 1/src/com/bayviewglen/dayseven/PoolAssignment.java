...
public class PoolAssignment {
	...
	public static void main(String[] args) {
		...
		double middleSurfaceArea = (2 * (width * shallowLength + shallowHeight * shallowLength + shallowHeight * width)
				+ ((2 * (width * middleLength + heightDifference * middleLength + heightDifference * width) / 2)));
